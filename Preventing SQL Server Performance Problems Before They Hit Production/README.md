...
- Open the __[DeploymentSchedule.sql](https://github.com/sabinio/SentryOne/S1_Deployment_Schema/)__ in SSMS and change the USE statement to point to the correct database.
...
- Right click any current Condition and click Import, Select each __[SabinIO](https://github.com/sabinio/SentryOne/S1_Conditions/)__ Condition to import.
  - If a Different database than WideWorldImporters is used, right click the SabinIO Deployment Advisory Condition and select Edit. Change the Database Name from WideWorldImporters to the desired database name.
