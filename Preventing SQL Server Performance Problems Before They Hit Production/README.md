...
- Open the __[DeploymentSchedule.sql](S1_Deployment_Schema/)__ in SSMS and change the USE statement to point to the correct database.
...
- Right click any current Condition and click Import, Select each __[SabinIO](S1_Conditions/)__ Condition to import.
